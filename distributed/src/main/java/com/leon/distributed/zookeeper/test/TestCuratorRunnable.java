...
import com.leon.distributed.zookeeper.service.impl.curator.CuratorDistributedLockImpl;
...
public class TestCuratorRunnable implements Runnable {
    ...
    public TestCuratorRunnable(CountDownLatch countDownLatch, String threadName) {
    ...
    public void run() {
        ...
        try {
            ...
            lock = new CuratorDistributedLockImpl( lockInfo);
    ...
    public static void main(String [] args) throws InterruptedException {
        ...
        for (int i = 0; i < countNum; i++) {
            ...
            new Thread(new TestCuratorRunnable(countDownLatch,"子线程" + (i+100))).start();
        }
